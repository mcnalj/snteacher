...
$public_domain = mysql_prep($_POST["public_domain"]);    
    ...
    $query .= " image_file, title, alt, width, height, source_link, author, author_link, license, license_link, html_code, public_domain ";
    $query .= ") VALUES (";
    $query .= " '{$image_file}', '{$title}', '{$alt}', '{$width}', '{$height}', '{$source_link}', '{$author}', '{$author_link}', '{$license}', '{$license_link}', '{$html_code}', '{$public_domain}' ";
    $query .= ")";
...
<body>
	...
	<main>
		<article id="quizSpace">
				...
				<br />
				<p>This is the page where you add the image file. It's not built yet, it's just a copy of insert_image.php.
