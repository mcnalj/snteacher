...
a:
	...
	$query_badges = "SELECT hawaii_badge, portland_badge, summer2015_badge, geography_badge, world_geography_badge, cortes_trial_badge, cortes_badge, africa_geography_badge, africa_countries_badge, constitution_badge, presidents_badge, civil_war_badge FROM students WHERE username = '{$_SESSION['student_username']}' ";
